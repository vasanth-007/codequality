        ...
        <div>
            <nav className='navbar navbar-expand-lg' style={{display:'flex',justifyContent:'space-between',height:'30px',marginTop:'20px'}}>
             ...
             <ul className='nav-container nav'>
                <div>
                 <li className='nav-item'><p style={{marginTop:'8px',fontWeight:'bold',fontFamily:'Roboto'}}>TICKETS</p></li>
                </div>
                <div>
                 <li className='nav-item'> <button id='bG' onMouseOver={changeColor} onMouseLeave={resetColor} type='button' className='btn btn-info' style={{color:'black',backgroundColor:'rgba(220,220,220,0.4)'}}>ALL</button></li>
                </div>
                <div>
                 <li className='nav-item'><button id='bG1' onMouseOver={changeColor1} onMouseLeave={resetColor1} type='button' className='btn btn-info' style={{color:'black',backgroundColor:'rgba(220,220,220,0.4)'}}>ONLY MY TICKETS</button></li>
                </div>
                <div>
                 <li className='nav-item'><button id='bG2' onMouseOver={changeColor2} onMouseLeave={resetColor2} type='button' className='btn btn-info' style={{color:'black',backgroundColor:'rgba(220,220,220,0.4)'}}>RECENTLY UPDATED</button></li>
                </div>
                <div>
                 <li className='nav-item'><button id='bG3' onMouseOver={changeColor3} onMouseLeave={resetColor type='button' className='btn btn-info' style={{color:'black',backgroundColor:'rgba(220,220,220,0.4)'}}> <FontAwesomeIcon icon="fa-solid fa-filter" /></button></li>
                </div>
                <div><li className='nav-item'><button id='bG4' onMouseOver={changeColor4} onMouseLeave={resetColor4}type='button' className='btn btn-info' style={{color:'black',backgroundColor:'rgba(220,220,220,0.4)'}}><FontAwesomeIcon icon={faRotate} /></button></li>
                </div>
             </ul>
             </div>
             ...
             <ul className='nav-container nav'>
                ...
                <div>
                 <li className='nav-item'><button id='bG5' onMouseOver={changeColor5} onMouseLeave={resetColor5} type='button' className='btn btn-info' style={{color:'black',backgroundColor:'rgba(220,220,220,0.4)'}}><FontAwesomeIcon icon={faGear}/>Configurations</button></li>
                </div>
                <div>
                 <li className='nav-item'>
